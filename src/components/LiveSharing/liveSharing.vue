<template>
  <div id="aaa" ref="wo" class="aaaaa" >
    <div class="videoLess" id='flxedoff'>
          <div class="isFixed">
              <video-player  style="width:100%; height:aotu" class="video-player vjs-custom-skin"
                    ref="videoPlayer"
                    :playsinline="true"
    ...
    data(){
        return {
            ...
            playerOptions : {
                ...
                sources: [{
                    type: "rtmp/mp4",
                    src: "rtmp://live.hzs2010.com/live/3706_3b1e0ff2786311e892905cb9018cf0d4" //url地址
                }],
                techOrder: ['flash'],
...
        },true)
    ...
    methods: {
          setVideo(){
               ...
               console.log('videoUrl',this.$store.state.videoUrl)
